	<?php $con=mysqli_connect("localhost","root","","ajax");
	if(isset($_POST['name']) && isset($_POST['email'])) { $name=$_POST['name'];
	$email=$_POST['email']; $sql="INSERT INTO ajax_insert
	(`name`,`email`)VALUES('$name','$email')"; $res=mysqli_query($con,$sql); }
